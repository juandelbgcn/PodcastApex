...
const contractABI = require("../artifacts/contracts/Podcastapex.sol/Podcastapex.json").abi;

program
    .name("podcastapex-cli")
    .description("CLI tool for Podcastapex smart contract")
    .version("1.0.0");
